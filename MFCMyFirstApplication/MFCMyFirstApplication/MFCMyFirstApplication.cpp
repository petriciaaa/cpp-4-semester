...
// MFCMyFirstApplication.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCMyFirstApplicationApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCMyFirstApplicationApp

CMFCMyFirstApplicationApp::CMFCMyFirstApplicationApp()
{
...
// Единственный объект CMFCMyFirstApplicationApp

CMFCMyFirstApplicationApp theApp;


// Инициализация CMFCMyFirstApplicationApp

BOOL CMFCMyFirstApplicationApp::InitInstance()
{
