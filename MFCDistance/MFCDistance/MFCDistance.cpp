...
// MFCDistance.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCDistanceApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCDistanceApp

CMFCDistanceApp::CMFCDistanceApp()
{
...
// Единственный объект CMFCDistanceApp

CMFCDistanceApp theApp;


// Инициализация CMFCDistanceApp

BOOL CMFCDistanceApp::InitInstance()
{
