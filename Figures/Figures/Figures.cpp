...
// Figures.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CFiguresApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CFiguresApp::OnAppAbout)
...
// Создание CFiguresApp

CFiguresApp::CFiguresApp() noexcept
{
	...
	SetAppID(_T("Figures.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CFiguresApp

CFiguresApp theApp;


// Инициализация CFiguresApp
...
BOOL CFiguresApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CFiguresDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CFiguresView));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CFiguresApp
...
void CFiguresApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Методы загрузки или сохранения настроек CFiguresApp

void CFiguresApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CFiguresApp::LoadCustomState()
{
}

void CFiguresApp::SaveCustomState()
{
}
